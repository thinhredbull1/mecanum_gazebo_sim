...
"""autogenerated by genpy from std_stamped_msgs/StringActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class StringActionFeedback(genpy.Message):
  _md5sum = "927953638888683891773f5d0111998b"
  _type = "std_stamped_msgs/StringActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','std_stamped_msgs/StringFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = std_stamped_msgs.msg.StringFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = std_stamped_msgs.msg.StringFeedback()
