...
(cl:defclass <MultiArrayLayout> (roslisp-msg-protocol:ros-message)
  ((dim
    :reader dim
    :initarg :dim
    :type (cl:vector std_stamped_msgs-msg:MultiArrayDimension)
   :initform (cl:make-array 0 :element-type 'std_stamped_msgs-msg:MultiArrayDimension :initial-element (cl:make-instance 'std_stamped_msgs-msg:MultiArrayDimension)))
   (data_offset
    :reader data_offset
    :initarg :data_offset
    :type cl:integer
...
(cl:defmethod cl:initialize-instance :after ((m <MultiArrayLayout>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MultiArrayLayout)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name std_stamped_msgs-msg:<MultiArrayLayout> is deprecated: use std_stamped_msgs-msg:MultiArrayLayout instead.")))

(cl:ensure-generic-function 'dim-val :lambda-list '(m))
(cl:defmethod dim-val ((m <MultiArrayLayout>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader std_stamped_msgs-msg:dim-val is deprecated.  Use std_stamped_msgs-msg:dim instead.")
  (dim m))

(cl:ensure-generic-function 'data_offset-val :lambda-list '(m))
(cl:defmethod data_offset-val ((m <MultiArrayLayout>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader std_stamped_msgs-msg:data_offset-val is deprecated.  Use std_stamped_msgs-msg:data_offset instead.")
  (data_offset m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MultiArrayLayout>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'dim)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'std_stamped_msgs-msg:MultiArrayDimension))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MultiArrayLayout>)))
  ...
  "std_stamped_msgs/MultiArrayLayout")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MultiArrayLayout)))
  "Returns string type for a message object of type 'MultiArrayLayout"
  "std_stamped_msgs/MultiArrayLayout")
