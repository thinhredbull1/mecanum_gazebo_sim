...
(cl:defmethod cl:initialize-instance :after ((m <Data>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Data)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name restricted_layer-msg:<Data> is deprecated: use restricted_layer-msg:Data instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader restricted_layer-msg:x-val is deprecated.  Use restricted_layer-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader restricted_layer-msg:y-val is deprecated.  Use restricted_layer-msg:y instead.")
  (y m))
