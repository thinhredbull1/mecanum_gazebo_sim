...
"""autogenerated by genpy from std_stamped_msgs/StringAction.msg. Do not edit."""
import codecs
import sys
...
import genpy
import std_msgs.msg
import std_stamped_msgs.msg

class StringAction(genpy.Message):
  _md5sum = "8db48ac1c73e6c12e7127041091397ab"
  _type = "std_stamped_msgs/StringAction"
...
"""
  ...
  _slot_types = ['std_stamped_msgs/StringActionGoal','std_stamped_msgs/StringActionResult','std_stamped_msgs/StringActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = std_stamped_msgs.msg.StringActionGoal()
      if self.action_result is None:
        self.action_result = std_stamped_msgs.msg.StringActionResult()
      if self.action_feedback is None:
        self.action_feedback = std_stamped_msgs.msg.StringActionFeedback()
    else:
      self.action_goal = std_stamped_msgs.msg.StringActionGoal()
      self.action_result = std_stamped_msgs.msg.StringActionResult()
      self.action_feedback = std_stamped_msgs.msg.StringActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_feedback.feedback.data
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_feedback.feedback.data = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_feedback.feedback.data = str[start:end]
      return self
